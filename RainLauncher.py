"""
rain's launcher — v1.3
animations: fade-in staggered · page crossfade · cover crossfade · hover smooth · pulse launch
"""
    ...
    def _apply_hover(self):
        ...
        try:
            ...
            for w in [self._name_lbl, self._path_lbl,
                ...
                w.config(bg=bg)
            self._launch_btn.master.config(bg=bg)  # bf frame
...
class RainsLauncher(tk.Tk):
    ...
    def _build_ui(self):
        ...
        self._stack = self._page_container  # alias
    ...
    def _switch_page(self, build_fn):
        """
        Fade-out la page courante, construit la nouvelle, fade-in.
        build_fn() doit créer les widgets dans self._stack.
        """
